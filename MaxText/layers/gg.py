...
#-----------------------------------------
# The Decoder Layer specific for gg
#-----------------------------------------


class GGDecoderLayer(nn.Module):
  ...
  def __call__(self,
    ...
    assert len(cfg.mlp_activations) == 2

    # MLP block.
    mlp_lnx = linears.RoeBlock(
        num_experts=cfg.num_experts,
        expert_dim=cfg.mlp_dim,
        expert_activation=cfg.mlp_activations[0],
        router_activation=cfg.mlp_activations[1],
