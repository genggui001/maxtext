...
python3 -u MaxText/train.py MaxText/configs/base.yml \
 ...
 mlp_activations=["relu","linear"] \
 pre_attention_activation=relu \
 pre_mlp_activation=relu \
 ...
 base_output_directory=gs://genggui001-us-central2/llm_checkpoints/_llama2_all_relu-1_1b_4k_add-chinese  \
