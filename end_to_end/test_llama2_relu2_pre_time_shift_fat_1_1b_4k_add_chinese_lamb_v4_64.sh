...
python3 -u MaxText/train.py MaxText/configs/base.yml \
 ...
 model_name='llama2_relu2_fat-1_1b-add-chinese' \
 pre_attention_activation='time_shift' \
 pre_mlp_activation='time_shift' \
 ...
 base_output_directory=gs://genggui001-us-central2/llm_checkpoints/llama2_relu2_pre_time_shift_fat-1_1b_4k_add-chinese  \
